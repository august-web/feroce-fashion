  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        disabled={isPending}
        className="appearance-none bg-white border border-line px-4 py-2.5 pr-8 text-[11px] font-sans uppercase tracking-luxury text-navy focus:outline-none focus:border-navy/30 cursor-pointer min-h-[40px] disabled:opacity-50"
        style={{
