...
export function HeroSection() {
  return (
    <section className="relative flex min-h-[90svh] md:min-h-[82vh] items-end overflow-hidden">
      {/* Background image */}
      ...
      <div className='absolute inset-0 md:hidden' style={{ background: 'linear-gradient(to top, rgba(10,17,40,0.92) 0%, rgba(10,17,40,0.65) 20%, rgba(10,17,40,0.4) 40%, rgba(10,17,40,0.25) 60%, transparent 80%)' }} />
      ...
      <div className='relative z-20 w-full px-5 pb-24 pt-12 sm:px-6 sm:pb-28 md:px-12 md:pb-24 lg:px-16'>
        <div className='mx-auto max-w-7xl'>
          ...
          <motion.div {...fadeUp(0.8)} className='mt-5 sm:mt-8 flex flex-wrap items-center gap-5 sm:gap-8'>
            ...
            <Link href='/shop' className='group flex items-center gap-2 text-[11px] font-sans uppercase text-white/90 transition-colors hover:text-gold' style={{ letterSpacing: '0.2em' }}>
