...
export const SEED_PRODUCTS: ExtendedProduct[] = [
  {
    ...
    color: "Blue & Gold", stock: 30, active: true, is_new: true, created_at: "2026-08-15",
    variants: [{
      color: "Blue & Gold", colorHex: "#2C4A6E",
      images: ["/images/products/Denim De Ville Collection/Blue & Gold/Denim De Ville Collection --Blue & Gold.jpg"],
      modelImages: ["/images/products/Denim De Ville Collection/Blue & Gold/Preserve_the_EXACT_F_ROCE_hand_2.jpg", "/images/products/Denim De Ville Collection/Blue & Gold/Preserve_the_EXACT_F_ROCE_hand_5.jpg"],
      stripe_checkout_url: "https://buy.stripe.com/3cIaEZ3HL19A3Nf0V2bV603", inStock: true
    }],
  ...
  },
  {
    ...
    color: "Cream & Gold", stock: 30, active: true, is_new: true, created_at: "2026-08-16",
    variants: [{
      color: "Cream & Gold", colorHex: "#F5F0E8",
      images: ["/images/products/Denim De Ville Collection/Cream & Gold/Denim De Ville Collection -- Cream & Gold.jpg"],
      modelImages: ["/images/products/Denim De Ville Collection/Cream & Gold/Preview 1.jpg", "/images/products/Denim De Ville Collection/Cream & Gold/Preview 2.jpg"],
      stripe_checkout_url: "https://buy.stripe.com/9B6cN7bad9G6gA10V2bV601", inStock: true
    }],
    sizes: [{ label: "One Size", available: true }],
  ...
  },
  {
    ...
    name: "Naji - Gold Fur", slug: "naji-gold-fur",
    description: "Luxurious gold fur-textured handbag with gold hardware. Bold statement, fierce elegance.",
    price: 45000,
    ...
    color: "Gold Fur", stock: 25, active: true, is_new: true, created_at: "2026-08-18",
    variants: [{
      color: "Gold Fur", colorHex: "#D4AF37",
      images: ["/images/products/Naji Collection/Gold Fur Bag/Naji Collection -- Golden Fur.jpg"],
      modelImages: ["/images/products/Naji Collection/Gold Fur Bag/Main-Preview.jpg", "/images/products/Naji Collection/Gold Fur Bag/Preview 2.jpg", "/images/products/Naji Collection/Gold Fur Bag/Preview 3.jpg"],
      stripe_checkout_url: "https://buy.stripe.com/9B6cN7bad9G6gA10V2bV601", inStock: true
    }],
    sizes: [{ label: "One Size", available: true }],
  ...
  },
  {
    ...
    name: "Naji - Maroon Red Fur", slug: "naji-maroon-red-fur",
    description: "Luxurious maroon red fur-textured handbag with gold hardware. Deep rich tones, fierce elegance.",
    price: 45000,
    ...
    color: "Maroon Red Fur", stock: 25, active: true, is_new: true, created_at: "2026-08-19",
    variants: [{
      color: "Maroon Red Fur", colorHex: "#722F37",
      images: ["/images/products/Naji Collection/Maroon Fur Bag/Naji Collection -- Maroon Red Fur.jpg"],
      modelImages: ["/images/products/Naji Collection/Maroon Fur Bag/Main-Preview.jpg", "/images/products/Naji Collection/Maroon Fur Bag/Preview 2.jpg", "/images/products/Naji Collection/Maroon Fur Bag/Preview 3.jpg", "/images/products/Naji Collection/Maroon Fur Bag/Preview 4.jpg"],
      stripe_checkout_url: "https://buy.stripe.com/cNi28tgux8C23NfgU0bV600", inStock: true
    }],
    sizes: [{ label: "One Size", available: true }],
